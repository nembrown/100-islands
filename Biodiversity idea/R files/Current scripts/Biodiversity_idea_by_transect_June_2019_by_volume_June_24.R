...
#average summer months net dimensions for that site across all years 
...
#sum of summer volume in that site that year 
...
#ggplot(ben_fish_data_wide_year_richness, aes(x=sum_volume,y=fish_richness, col=site))+geom_point()+geom_line()
...
ben_size_data_wide_year_richness$fish_sd<-rowSds(as.matrix(ben_size_data_wide_year[,-c(1,2)]),na.rm = TRUE)
...
ben_biomass_data_wide_year<-(ben_size_data_wide_year[,-c(1,2,3,4,5)])*(ben_fish_data_wide_year[,-c(1,2,3,4,5)])
...
ben_biomass_data_wide_year_nf<-merge(ben_biomass_data_wide_year_nf, ben_netdimensions_summer)
...
fish_richness_merged_tran_year<-merge(ben_fish_data_wide_year_richness[,-4], ben_netdimensions_year, by="site", all=TRUE)
...
head(fish_bycatch_richness_merged_tran_year)
#this is just the marine data so far

ggplot(fish_bycatch_richness_merged_tran_year, aes(x=bycatch_richness_bym3, y=fish_richness_bym3))+geom_point()
ggplot(fish_bycatch_richness_merged_tran_year, aes(x=site, y=fish_richness))+geom_point()


#### add transects in here instead
hakai_sites_distance_tran<-read.csv("C:Distance_btwn_points_transects.csv")
...
hakai_sites_distance_tran<- hakai_sites_distance_tran%>% filter(Distance < 1)
head(hakai_sites_distance_tran )
...
by_tran_master_0m<-read.csv("C:Norah.data\\by_tran_master_0m.csv")
...
setwd("C:/Users/Norah/Dropbox/Projects/100 islands/Biodiversity idea")
write.csv(fish_richness_merged_tran_isl, "C:fish_richness_merged_tran_isl.csv")
...
# Determining scale of comparison -----------------------------------------
ggplot(fish_richness_merged_tran_isl, aes(x=fish_richness_corrected, y=d15n))+geom_point()+geom_smooth(method="lm")+ggtitle("100 m")

ggplot(fish_richness_merged_tran_isl, aes(x=fish_richness_corrected, y=d15n))+geom_point()+geom_smooth(method="gam")
...
plot_grid(n15_100, n15_250, n15_300, n15_400, n15_500,n15_600,n15_3k,n15_2k, n15_1000, ncol=3)
...
head(fish_richness_merged_tran_isl_1k)
ggplot(fish_richness_merged_tran_isl_1k, aes(x=fish_richness_corrected, y=s, col=intertidal_primary_macroveg))+geom_point()+geom_smooth(method="lm")+ggtitle("1k")
ggplot(fish_richness_merged_tran_isl_1k, aes(x=fish_richness_corrected, y=s, col=subtidal_primary_macroveg))+geom_point()+geom_smooth(method="lm")+ggtitle("1k")
ggplot(fish_richness_merged_tran_isl_1k, aes(x=fish_richness_corrected, col=s, y=subtidal_primary_cover))+geom_point()+geom_smooth(method="lm")+ggtitle("1k")

ggplot(fish_richness_merged_tran_isl_1k, aes(x=fish_richness_corrected, col=s, y=subtidal_primary_cover))+geom_point()+geom_smooth(method="lm")+ggtitle("1k")

ggplot(fish_richness_merged_tran_isl_1k, aes(x=subtidal_primary_cover, y=subtidal_secondary_cover, col=subtidal_secondary_macroveg))+geom_point()+geom_smooth(method="lm")+ggtitle("1k")

ggplot(fish_richness_merged_tran_isl_1k, aes(x=fish_richness_corrected, y=s, col=subtidal_secondary_cover))+geom_point()+geom_smooth(method="lm")+ggtitle("1k")


#### Okay so 300m is the chosen size

ggplot(fish_richness_merged_tran_isl_300, aes(x=marine_richness_corrected, y=d15n))+geom_point()+geom_smooth(method="lm")+geom_text(aes(label=site))
ggsave("C:Plots//Transect//Resources_terr_var//300_marine_richness_n15_scale_by_day_volume.png", width=40, height=20, unit="cm")



# Chemistry by marine richness ---------------------------------------
...
marine2<-ggplot(fish_richness_merged_tran_isl_300, aes(x=log(fish_abundance_bym3), y=bycatch_abundance_bym3))+geom_point()+geom_smooth(method="lm")
marine3<-ggplot(fish_richness_merged_tran_isl_300, aes(x=fish_richness_corrected, y=log(fish_abundance_bym3)))+geom_point()+geom_smooth(method="lm")
marine4<-ggplot(fish_richness_merged_tran_isl_300, aes(x=bycatch_richness_corrected, y=bycatch_abundance_bym3))+geom_point()+geom_smooth(method="lm")
marine16<-ggplot(fish_richness_merged_tran_isl_300, aes(x=wrack_richness, y=log_site_sum_by_tran))+geom_point()+geom_smooth(method="lm")
marine17<-ggplot(fish_richness_merged_tran_isl_300, aes(x=fish_richness_corrected, y=fish_length))+geom_point()+geom_smooth(method="lm")
plot_grid(marine1, marine2, marine3, marine4,marine17, ncol=3)
...
n_marine1<-ggplot(fish_richness_merged_tran_isl_1k, aes(y=d15n, x=log(bycatch_abundance_bym3+1)))+geom_point()+geom_smooth(method="gam")
n_marine2<-ggplot(fish_richness_merged_tran_isl_1k, aes(y=d15n, x=bycatch_richness_corrected))+geom_point()+geom_smooth(method="gam")
n_marine3<-ggplot(fish_richness_merged_tran_isl_1k, aes(y=d15n, x=log(fish_abundance_bym3+1)))+geom_point()+geom_smooth(method="gam")
n_marine4<-ggplot(fish_richness_merged_tran_isl_1k, aes(y=d15n, x=fish_richness_corrected))+geom_point()+geom_smooth(method="gam")
n_marine5<-ggplot(fish_richness_merged_tran_isl_1k, aes(y=d15n, x=log(fish_biomass_bym3+1)))+geom_point()+geom_smooth(method="gam")
n_marine6<-ggplot(fish_richness_merged_tran_isl_1k, aes(y=d15n, x=fish_length))+geom_point()+geom_smooth(method="gam")
n_marine7<-ggplot(fish_richness_merged_tran_isl_1k, aes(y=d15n, x=marine_richness_corrected))+geom_point()+geom_smooth(method="gam")
n_marine8<-ggplot(fish_richness_merged_tran_isl_1k, aes(y=d15n, x=fish_sd))+geom_point()+geom_smooth(method="gam")
...
s_marine1<-ggplot(fish_richness_merged_tran_isl_1k, aes(y=s, x=log(bycatch_abundance_bym3+1)))+geom_point()+geom_smooth(method="gam")
s_marine2<-ggplot(fish_richness_merged_tran_isl_1k, aes(y=s, x=bycatch_richness_corrected))+geom_point()+geom_smooth(method="gam")
s_marine3<-ggplot(fish_richness_merged_tran_isl_1k, aes(y=s, x=log(fish_abundance_bym3+1)))+geom_point()+geom_smooth(method="gam")
s_marine4<-ggplot(fish_richness_merged_tran_isl_1k, aes(y=s, x=fish_richness_corrected))+geom_point()+geom_smooth(method="gam")
s_marine5<-ggplot(fish_richness_merged_tran_isl_1k, aes(y=s, x=log(fish_biomass_bym3+1)))+geom_point()+geom_smooth(method="gam")
s_marine6<-ggplot(fish_richness_merged_tran_isl_1k, aes(y=s, x=fish_length))+geom_point()+geom_smooth(method="gam")
s_marine7<-ggplot(fish_richness_merged_tran_isl_1k, aes(y=s, x=marine_richness_corrected))+geom_point()+geom_smooth(method="gam")
s_marine8<-ggplot(fish_richness_merged_tran_isl_1k, aes(y=s, x=fish_sd))+geom_point()+geom_smooth(method="gam")

plot_grid(s_marine4, s_marine5, s_marine7, s_marine3, s_marine2, s_marine1,s_marine6,s_marine8, ncol=4)
ggsave("C:Plots//Transect//Resources_terr_var//s_marine_corrected.png")
...
ggsave("C:Plots//Transect//Resources_biogeog//histitude_marine.png")
