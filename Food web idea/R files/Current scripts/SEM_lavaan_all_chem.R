...
sem_variables_names_veg_allchem<-c("node", "unq_tran","unq_isl", "log_fish_biomass_bym3_mean", "log_bycatch_biomass_bym3_mean",
                           ...
                           "slope_isl", "CHM_mean_height", "habitat_het", "NDVI_mean", "d13c", "cn", "d34s", "s", "n", "c")
...
N15_model_simple_centered_alt_veg_allchem<-'
        ...
        c.n ~ c.d15n + w1*c.log_site_mean_by_tran + h1*c.distance_to_midden + pres_marine_invert + pres_fish + c.slope_degrees  + c.WAVE_EXPOSURE + pres_otter + ravens + eagles + elevation_max + c.slope_isl  + c.log_Bog_area + c.CHM_mean_height
        
        c.c ~  w1*c.log_site_mean_by_tran + h1*c.distance_to_midden + pres_marine_invert + pres_fish + c.slope_degrees  + c.WAVE_EXPOSURE + pres_otter + ravens + eagles + elevation_max + c.slope_isl  + c.log_Bog_area + c.CHM_mean_height
        ...
        c.s ~ c.d34s + w1*c.log_site_mean_by_tran + h1*c.distance_to_midden + pres_marine_invert + pres_fish + c.slope_degrees  + c.WAVE_EXPOSURE + pres_otter + ravens + eagles + elevation_max + c.slope_isl  + c.log_Bog_area + c.CHM_mean_height
...
fml.veg_allchem <- list( c.log_fish_biomass_bym3_mean + c.log_bycatch_biomass_bym3_mean +
                   ...
                   pres_marine_invert + pres_fish + c.log_MEAN_rockarea2000 + c.s + c.d34s + c.c + c.cn + c.d13c + c.n  ~ 1 + (1|unq_isl) ,                                                 # Level 1
...
lavaan_fit_model_veg_allchem<-sem(N15_model_simple_centered_alt_veg_allchem)
...
grps_allchem<-list(Algae=c("c.log_MEAN_rockarea2000","c.log_site_mean_by_tran", "c.log_MEAN_kparea2k", "c.log_MEAN_egarea2k" ),
           ...
           outcome=c("c.d15n", "c.c", "c.d13c", "c.d34s", "c.s", "c.cn", "c.n"))
...
lay_names_veg_allchem<-get_layout("d34S\nsoil", "", "", "", "", "","","","","","","S\nsoil","","","","","","","","","","","","","","","","","","","","","", "","", "","d15N\nsoil",   "","","", "","","","","", "N\nsoil","","","","","","","","","","","","","","","","","","","d13C\nsoil","","","","","","","","C\nsoil","","","","","","","","",
                          "wrack","","", "","","","","", "","","","","","", "","", "shell","","","","","","", "fish\nbones", "","", "","","","","","","","","","","","","","","","", "","","","","", "","","","", "","","","","","","","","","","","","","","","","","","","","","","","","","","","","","",
...
semPlot::semPaths(fit.adj.mitml.veg_allchem, "path",fade = F, residuals = F, intercepts=FALSE, label.cex=2, nCharNodes = 0, nodeLabels = 1:30)
